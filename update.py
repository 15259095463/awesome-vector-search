...
| [autofaiss](https://criteo.github.io/autofaiss/) | This lib creates quantized indices for similarity search on dense vectors. Once the index is created with this library, you can use deepr_knn to deploy you index and use it through an API. | [yes](https://github.com/criteo/autofaiss) | """ + autofaissDate + """ |
