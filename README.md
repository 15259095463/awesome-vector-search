...
| [Jina](https://jina.ai/) | Jina is a MLOps framework that empowers anyone to build cross-modal and multi-modal applications on the cloud. It uplifts a PoC into a production-ready service. Jina handles the infrastructure complexity, making advanced solution engineering and cloud-native technologies accessible to every developer. | [yes](https://github.com/jina-ai/jina) | 2022-12-07T11:39:59Z |
...
| [Vespa](https://vespa.ai/) | Vespa is a full-featured text search engine and supports both regular text search and fast approximate vector search (ANN).  | [yes](https://github.com/vespa-engine/vespa) | 2022-12-07T11:34:21Z |
...
| [ScaNN](https://github.com/google-research/google-research/tree/master/scann) | ScaNN is a vector similarity search library. | [yes](https://github.com/google-research/google-research/tree/master/scann) | 2022-12-06T18:33:54Z |
