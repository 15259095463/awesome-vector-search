...
| [PASE](https://github.com/alipay/PASE) | PASE (PostgreSQL ANN search extension) is a high-performance vector retrieval index plug-in developed for PostgreSQL database.  | [yes](https://github.com/alipay/PASE) | ![PASE](https://flat.badgen.net/github/last-commit/alipay/alipay-easysdk) |
